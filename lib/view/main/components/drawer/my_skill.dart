...
class MySKills extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        AnimatedLinearProgressIndicator(percentage: 0.8, title: 'Android | Web Development',image: 'assets/icons/flutter.png',),
        ...
        AnimatedLinearProgressIndicator(percentage: 0.55, title: 'Responsive Design',image: 'assets/icons/flutter.png'),
        AnimatedLinearProgressIndicator(percentage: 0.7, title: 'Clean Architecture',image: 'assets/icons/flutter.png'),
        AnimatedLinearProgressIndicator(percentage: 0.85, title: 'Backend Development',image: 'assets/icons/python.png'),
